...
{
    public class RGPMasterResponse:CommonEntityModel
    {
        ...
        public virtual GatePassMasterResponse GatePassMaster { get;set; }
        public virtual PurchaseOrderResponse PurchaseOrderMaster { get; set; }//new
